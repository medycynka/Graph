...
inline size_t getMinVertex(const Graph<V, E> &g, std::vector<bool> &vis, std::vector<double> &keys){
    double minKey = INF;
...
template<typename V, typename E>
inline void dijkstraSimple(const Graph<V, E> &g, size_t source) {
...
template<typename V, typename E>
inline void printPathDijkstra(const Graph<V, E> &g, size_t source, std::vector<double> &keys){
...
template<typename V, typename E>
inline void computeFloydWarshall(const Graph<V, E> &g){
    std::vector<std::vector<std::optional<E>>> temp = g.getNeighMatrix();
    auto size_ = g.nrOfVertices();
...
template<typename V, typename E>
inline void printPathFloydWarshall(const Graph<V, E> &g, std::vector<std::vector<std::optional<E>>> &input){
...
template<typename V, typename E>
inline void primsMST(const Graph<V, E> &g){
...
template<typename V, typename E>
inline bool isValidForColors(const Graph<V, E> &g, size_t vertex_id, std::vector<size_t> &col, size_t col_checker){
    auto nm = g.getNeighMatrix();
...
template<typename V, typename E>
inline bool tryGraphColoring(const Graph<V, E> &g, size_t nrOfColorsToTry, size_t vertex_id, std::vector<size_t> &col){
    auto size_ = g.nrOfVertices();
...
template<typename V, typename E>
inline bool checkColoringResult(const Graph<V, E> &g, size_t nrOfColorsToTry){
...
template<typename V, typename E>
inline std::pair<size_t, bool>  colorUntilDone(const Graph<V, E> &g){
    auto size_ = g.nrOfVertices();
...
template<typename V, typename E>
inline void printColors(const Graph<V, E> &g, std::vector<size_t> &col){
...
template<typename V, typename E>
inline bool checkVerticesDFS_undirected(const Graph<V, E> &g, size_t curr, std::set<size_t> &wSet, std::set<size_t> &gSet, std::set<size_t> &bSet){
...
template<typename V, typename E>
inline bool hasCycle_undirected(const Graph<V, E> &g){
...
template<typename V, typename E>
inline bool checkVerticesDFS_directed(const Graph<V, E> &g, size_t curr, std::set<size_t> &vis, size_t parent){
    vis.insert(curr);
    auto nm = g.getNeighMatrix();
...
template<typename V, typename E>
inline bool hasCycle_directed(const Graph<V, E> &g){
...
template<typename V, typename E>
inline bool isSafeVertex(const Graph<V, E> &g, size_t vertex_id, std::vector<ssize_t> &path, size_t pos){
...
template<typename V, typename E>
inline bool tryFindingHamCycle(const Graph<V, E> &g, std::vector<ssize_t> &path, size_t pos){
...
template<typename V, typename E>
inline bool hasHamiltonCycle(const Graph<V, E> &g, size_t startingVertex){
    std::vector<ssize_t> path(g.nrOfVertices(), -1);
    path.at(0) = 0;
...
inline void printHamiltonCycle(std::vector<ssize_t> &path, const size_t &nr_of_vertices){
...
template<typename V, typename E>
inline ssize_t getInDegree(const Graph<V, E> &g, size_t vertex_id){
...
template<typename V, typename E>
inline ssize_t getOutDegree(const Graph<V, E> &g, size_t vertex_id){
    if(vertex_id >= g.nrOfVertices() || vertex_id < 0) return -1;
    else{
        ssize_t degree = 0;
        auto nm = g.getNeighMatrix();
...
template<typename V, typename E>
inline std::vector<V> getOutConnectedVerticesTo(const Graph<V, E> &g, size_t vertex_id){
    std::vector<V> result;
    auto nm = g.getNeighMatrix();
    auto v = g.getVertices();
...
template<typename V, typename E>
inline std::vector<V> getInConnectedVerticesTo(const Graph<V, E> &g, size_t vertex_id){
    std::vector<V> result;
    auto nm = g.getNeighMatrix();
    auto v = g.getVertices();
...
#endif //GRAPH_GRAPH_ALGORITHMS_HPP
